...
class MyApp_Tests_Bootstrap {
	...
	public function bootstrap() {
		...
		require_once $this->app_directory . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'TradeFair.php';
		require_once $this->app_directory . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'helpers.php';
	}
}
